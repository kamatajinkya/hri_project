...
class HumanTrackedEventWatcher(ALModule):
	def __init__(self):
		...
		self.tts.setParameter("speed", 20000)
	...
	def onHumanTracked(self, key, value, msg):
		if value >= 0:
			...
			self.tts.say("Hello Olivia and Ajinkya how are you today?")
			self.tts.say("Is there anything I can help you with during your time here?")			
